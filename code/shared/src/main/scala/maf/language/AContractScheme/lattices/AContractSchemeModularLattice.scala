...
class AContractSchemeModularLattice[A <: Address, S: StringLattice, B: BoolLattice, I: IntLattice, R: RealLattice, C: CharLattice, Sym: SymbolLattice, N: NumberLattice]
    extends ASchemeModularLattice[A, S, B, C, Sym, N],
